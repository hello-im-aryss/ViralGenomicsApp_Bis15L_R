...
colors_cont<-LaCroixColoR::lacroix_palette("Pamplemousse", n = 14, type = "continuous") #as long as the data you're describing is under 187 points long
...
virus4 %>% 
  ggplot(aes(x=number_of_hosts, fill=number_of_hosts,fill=host_f))+
  geom_bar()+
  theme_solarized()+
...
virus4 %>% 
  ggplot(aes(x=number_of_hosts,y=size_to_gene_ratio,group=number_of_hosts,fill=host_f))+
  geom_col()+
  theme_solarized()+
...
virus4 %>% 
  ggplot(aes(x=number_of_hosts, y=genes, group=number_of_hosts,fill=host_f))+
  geom_col()+
  theme_solarized()+
  scale_fill_manual(values=colors_cont)+
  theme(legend.position="top",
...
virus4 %>% 
  ggplot(aes(x=number_of_hosts, y=size_mb, group=number_of_hosts,fill=host_f))+
  geom_col()+
  theme_solarized()+
  scale_fill_manual(values=colors_cont)+
  theme(legend.position="top",
