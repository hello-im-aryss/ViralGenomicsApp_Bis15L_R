...
read_csv(here("Yumna Data Cleanup and Graphs", "Data", "viruses.csv")) 
```
...
colors_cont_5<-LaCroixColoR::lacroix_palette("Pamplemousse", n = 5, type = "discrete")#as long as the data you're describing is under 187 points long
